  ...
  return (
    <div className="min-h-screen">
      <button
        ...
        className="fixed top-6 right-6 z-40 px-6 py-3 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-full shadow-lg flex items-center gap-2 transition-all hover:scale-105"
      >
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto">
          <div className="space-y-4 mb-16">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl font-light text-white/85 leading-relaxed">
              Current firefighting methods are slow, dangerous, and resource-intensive
            </p>
          </div>
          ...
          <div className="space-y-6 mt-20">
            ...
            <p className="text-2xl md:text-3xl lg:text-4xl font-semibold text-amber-400 leading-tight">
              Restricting Wildfires BEFORE They Climb Up Into the Canopy
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <div className="flex flex-col items-center text-center group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">
                Create Fire Barriers – Where It Matters Most
              </h3>
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Controlled prevention for long-term protection
              </p>
            </div>
          </div>
        </div>
