...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden" style={{ paddingTop: '8rem' }}>
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto">
          <div className="space-y-3 mb-12">
            <h2 className="text-base md:text-xl lg:text-2xl font-light text-white/90 leading-relaxed">
              Wildfires Are Growing More Intense and Destructive
            </h2>
            <p className="text-sm md:text-lg lg:text-xl font-light text-white/85 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-32 flex flex-col items-center">
            ...
            <h3 className="text-3xl font-bold text-slate-900 mt-8">
              Extindro on its way to Deployment
            </h3>
          </div>
        </div>
      </section>
